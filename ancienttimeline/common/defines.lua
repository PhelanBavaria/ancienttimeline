...
NCountry = {
	...
	MIN_TECH_FOR_CIRCUMNAVIGATE = 49,			-- Must have this level of dip tech to circumnavigate the globe
	...
	PRIMITIVES_TECH_MODIFIER = 0.4,					-- Technology groups with a slower modifier than this count as 'primitives'
	...
	WESTERNISATION_THRESHOLD = 15,					-- techs behind to be allowed to westernize.
	WESTERN_POWER_TICK = 8,					-- max power to transfer every month.
	WESTERN_POWER_TICK_MIN = 4,				-- min power to transfer every month.
	WESTERN_NEEDED_BASE_POWER = 3000,					-- needed for full westernisation
	WESTERN_NEEDED_MAX_POWER = 6000,					-- needed for full westernisation
	...
	ADVISOR_COST_INCREASE_PER_YEAR = 0.0005,			-- yearly increase in price in percent,
	...
	FREE_IDEA_GROUP_COST  = 10,						-- modifier on cheapness of "free" idea group
	MAX_TOLERANCE_HERETIC = 6, 						-- maximum tolerance towards heretics
	MAX_TOLERANCE_HEATHEN = 6, 						-- maximum tolerance towards heathens
	...
	REVOLT_TECH_MORALE = 0.0015,			-- 1% per tech level

	REBEL_ARTILLERY_INCREASE_LEVEL_1_TECH = 56,		-- Tech level at which REBEL_ARTILLERY_INCREASE_LEVEL_1_SIZE is applied
	REBEL_ARTILLERY_INCREASE_LEVEL_1_SIZE = 0.1,	-- The increase in artillery as fraction of total troops given to rebels
	REBEL_ARTILLERY_INCREASE_LEVEL_2_TECH = 61,		-- Tech level at which REBEL_ARTILLERY_INCREASE_LEVEL_2_SIZE is applied
	...
	PROTECTORATE_TECH_THRESHOLD = 0.25,				-- Difference in tech group cost modifiers
...
NEconomy = {
	...
	LAND_TECH_MAINTENANCE_IMPACT = 0.002, 			-- % each tech increases it.
